...
sage -python export_wb.py --input-file crax64_128_affine_layers_affineEncoding.sobj --irf-degree 2 --first-explicit-round "" --disabled-redundant-perturbations --cancel-external-encodings --debug-file DEBUG_crax64_128_affine_layers_affineEncoding
