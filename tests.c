...
int main(void){
    ...
    // result = Simon_Init(&my_simon_cipher, cfg_64_32, ECB, simon64_32_key, my_IV, my_counter);
    ...
    // result = Simon_Init(&my_simon_cipher, cfg_72_48, ECB, simon72_48_key, my_IV, my_counter);
    ...
    // result = Simon_Init(&my_simon_cipher, cfg_96_48, ECB, simon96_48_key, my_IV, my_counter);
    ...
    // result = Simon_Init(&my_simon_cipher, cfg_96_64, ECB, simon96_64_key, my_IV, my_counter);
    ...
    // result = Simon_Init(&my_simon_cipher, cfg_128_64, ECB, simon128_64_key, my_IV, my_counter);
    // printf("Encryption Test:\n");
    ...
    // result = Simon_Init(&my_simon_cipher, cfg_96_96, ECB, simon96_96_key, my_IV, my_counter);
    // printf("Encryption Test:\n");
    ...
    // result = Simon_Init(&my_simon_cipher, cfg_144_96, ECB, simon144_96_key, my_IV, my_counter);
    // printf("Encryption Test:\n");
    ...
    // result = Simon_Init(&my_simon_cipher, cfg_192_128, ECB, simon192_128_key, my_IV, my_counter);
    // printf("Encryption Test:\n");
    ...
    // result = Simon_Init(&my_simon_cipher, cfg_256_128, ECB, simon256_128_key, my_IV, my_counter);
    // printf("Encryption Test:\n");
    ...
    // result = Speck_Init(&my_speck_cipher, cfg_72_48, ECB, speck72_48_key, my_IV, my_counter);
    ...
    // result = Speck_Init(&my_speck_cipher, cfg_96_48, ECB, speck96_48_key, my_IV, my_counter);
    ...
    // result = Speck_Init(&my_speck_cipher, cfg_96_64, ECB, speck96_64_key, my_IV, my_counter);
    ...
    // result = Speck_Init(&my_speck_cipher, cfg_96_96, ECB, speck96_96_key, my_IV, my_counter);
    ...
    // result = Speck_Init(&my_speck_cipher, cfg_144_96, ECB, speck144_96_key, my_IV, my_counter);
    ...
    // result = Speck_Init(&my_speck_cipher, cfg_128_128, ECB, speck128_128_key, my_IV, my_counter);
    ...
    // result = Speck_Init(&my_speck_cipher, cfg_192_128, ECB, speck192_128_key, my_IV, my_counter);
    ...
    // result = Speck_Init(&my_speck_cipher, cfg_256_128, ECB, speck256_128_key, my_IV, my_counter);
